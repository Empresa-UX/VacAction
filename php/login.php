...
<body>
    <section id="login-content">
        ...
        <form method="POST" action="http://localhost/VacAction/conection.php">
            ...
            <div class="enlaceCTA">
                <a href="../html/forgot.html" name="fotgot">Forgot password?</a>
                <a href="../html/register.html" name="register">Don't have an account?</a>
            </div>
        </form>
    </section>

    <footer>
        <div><p>Derechos reservados : VacAction ©</p></div>
        <div><p>Derechos reservados : VacAction ©</p></div>
        <div><p>Derechos reservados : VacAction ©</p></div>
    </footer>
</body>
